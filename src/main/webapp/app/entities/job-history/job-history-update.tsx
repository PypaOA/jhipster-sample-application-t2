  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="t2App.jobHistory.home.createOrEditLabel" data-cy="JobHistoryCreateUpdateHeading">
            <Translate contentKey="t2App.jobHistory.home.createOrEditLabel">Create or edit a JobHistory</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('t2App.jobHistory.startDate')}
              ...
              />
              <ValidatedField
                label={translate('t2App.jobHistory.endDate')}
              ...
              />
              <ValidatedField
                label={translate('t2App.jobHistory.language')}
              ...
              >
                {languageValues.map(language => (
                  <option value={language} key={language}>
                    {translate('t2App.Language.' + language)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField id="job-history-job" name="job" data-cy="job" label={translate('t2App.jobHistory.job')} type="select">
                <option value="" key="0" />
                {jobs
              ...
              <ValidatedField
                ...
                name="department"
                data-cy="department"
                label={translate('t2App.jobHistory.department')}
                type="select"
              >
                <option value="" key="0" />
                {departments
              ...
              <ValidatedField
                ...
                name="employee"
                data-cy="employee"
                label={translate('t2App.jobHistory.employee')}
                type="select"
              >
                <option value="" key="0" />
                {employees
