  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="t2App.country.home.createOrEditLabel" data-cy="CountryCreateUpdateHeading">
            <Translate contentKey="t2App.country.home.createOrEditLabel">Create or edit a Country</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('t2App.country.countryName')}
                id="country-countryName"
                name="countryName"
                data-cy="countryName"
                type="text"
              />
              <ValidatedField id="country-region" name="region" data-cy="region" label={translate('t2App.country.region')} type="select">
                <option value="" key="0" />
                {regions
