    ...
    <Row>
      <Col md="8">
        <h2 data-cy="jobDetailsHeading">
          <Translate contentKey="t2App.job.detail.title">Job</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="jobTitle">
              <Translate contentKey="t2App.job.jobTitle">Job Title</Translate>
            </span>
          </dt>
          <dd>{jobEntity.jobTitle}</dd>
          <dt>
            <span id="minSalary">
              <Translate contentKey="t2App.job.minSalary">Min Salary</Translate>
            </span>
          </dt>
          <dd>{jobEntity.minSalary}</dd>
          <dt>
            <span id="maxSalary">
              <Translate contentKey="t2App.job.maxSalary">Max Salary</Translate>
            </span>
          </dt>
          <dd>{jobEntity.maxSalary}</dd>
          <dt>
            <Translate contentKey="t2App.job.task">Task</Translate>
          </dt>
          <dd>
            {jobEntity.tasks
          ...
          <dt>
            <Translate contentKey="t2App.job.employee">Employee</Translate>
          </dt>
